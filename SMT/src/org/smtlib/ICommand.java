...
public interface ICommand extends IAccept {
  ...
  static public interface IFactory {
    ...
    Idefine_fun define_fun(IIdentifier id, List<IDeclaration> declarations, ISort resultSort,
        IExpr expression);

    /** Creates a define-sort command object. */
    Idefine_sort define_sort(IIdentifier id, List<IParameter> parameters,
