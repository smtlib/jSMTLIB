...
public class APIExample {
  ...
  public static void main(String... args) {
    ...
    try {
          ...
          smt.smtConfig.smtFactory.createSource(
              new CharSequenceReader(
                  new java.io.StringReader(
                      "(set-option :produce-models true)(set-logic QF_UF)(declare-fun p () Bool)")),
              null);
      ...
      source =
          smt.smtConfig.smtFactory.createSource(
              new CharSequenceReader(new java.io.StringReader("(assert )")), null);
      ...
      // Execute the script
      ISolver solver = new org.smtlib.solvers.Solver_z3_4_8_5(smt.smtConfig);
      solver.start();
      ...
      script.commands().add(command4);
      solver = new org.smtlib.solvers.Solver_z3_4_8_5(smt.smtConfig);
      solver.start();
      ...
      r =
          solver.declare_fun(
              new C_declare_fun(efactory.symbol("pb"), new java.util.LinkedList<ISort>(), bv32));
      r =
          solver.declare_fun(
              new C_declare_fun(efactory.symbol("pc"), new java.util.LinkedList<ISort>(), bv32));
      ...
      r =
          solver.assertExpr(
              efactory.fcn(
                  efactory.symbol("="),
                  efactory.symbol("pc"),
                  efactory.fcn(efactory.symbol("bvnot"), efactory.symbol("pb"))));
      r = solver.check_sat();
      System.out.println(printer.toString(r));
      ...
      r =
          solver.assertExpr(
              efactory.fcn(
                  efactory.symbol("="),
                  efactory.symbol("pb"),
                  efactory.binary("01001010010100101001010010100111")));
      r = solver.check_sat();
      System.out.println(printer.toString(r));
      r = solver.get_value(efactory.symbol("pb"), efactory.symbol("pc"));
      System.out.println(printer.toString(r));
