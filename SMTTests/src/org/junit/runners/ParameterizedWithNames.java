...
// Reviewed: DRCok 2015-05-15
package org.junit.runners;


/** This class is a minor modification of org.junit.runners.Parameterized. The changes are just to allow
 *  inserting a parameter value instead of the index as the name of a test. It is the first parameter that
 *  is used, which, if you desire, can be used solely to specify the name of the test.
 *  <BR>
