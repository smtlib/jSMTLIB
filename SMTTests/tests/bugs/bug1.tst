; Formalized from SMT/bugs/temp.smt2 -- a scratch smoke test for quantifiers,
; :pattern triggers, and forall/exists under the ALL logic (no check-sat; just
; confirms the script parses and type-checks).
